...
<head>
  ...
  <title>Nhóm 6: CHỈNH SỬA THÔNG TIN NHÂN VIÊN</title>
  <!-- plugins:css -->
              ...
              <form class="forms-sample" method="POST" action="update-moderator.php">
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="password" class="form-control" name = "ud_password" placeholder="Password">
                  </div>
                  <div class="form-group col-6">
                    <label for="password">Xác nhận mật khẩu</label>
                    <input type="password" class="form-control" name = "reenter_password" placeholder="Xác nhận password">
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-6">
