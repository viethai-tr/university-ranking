...
<head>
  ...
  <title>Nhóm 6: DANH SÁCH NHÂN VIÊN</title>
  <!-- plugins:css -->
                ...
                <div class="page-header">
                  ...
                  <div class="search-field d-none d-md-block">
                      <div class="input-group">
                        ...
                        <input type="text" name="search_box" id="search_box" class="form-control bg-transparent border-0" placeholder="Tìm kiếm tên nhân viên">
                      </div>
                  </div>
                </div>
