        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" method="POST" action="update-university.php" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                  <div class="form-group col-4">
                      ...
                      <select id="country" name="ud_country" class="form-control btn">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        <label for="exampleInputEmail3">Điểm nghiên cứu</label>
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="file" name="ud_university_image" accept="image/*">
                  </div>
                </div>
